<template>
	<transition name="fade">
		<div v-if="showStep" class="Confirmation">
			<form class="Confirmation__form" ref="form" @submit.prevent>
				<FormItem label-for="email" label="Email">
					<FormInput
						id="email"
						v-model="email"
						type="email"
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations(['setShowStep', 'updateData']),
		},
		mounted() {
